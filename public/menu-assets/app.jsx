...
function App() {
  ...
  // Table comes from the scanned QR (…/menu?t=<token> → resolved by the adapter).
  const TABLE = (window.AKAN_TABLE && window.AKAN_TABLE.number) || '—';
  ...
  if (route.name === 'landing') {
    screen = <Landing table={TABLE} onEnter={() => { setStack([]); setRoute({ name: 'home' }); }} />;
