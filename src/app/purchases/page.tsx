...
export default function PurchasesPage() {
  ...
  const downloadSkippedRows = () => {
    ...
    const header = ['date', 'vendor', 'bill_no', 'category_name', 'item_name',
    ...
    const lines = [header.join(',')].concat(rows.map(r =>
      [r.date, r.vendor, r.bill_no, r.category_name, r.item_name,
    ...
    const rows = [
      {
        ...
        category_name: ex1?.category || '', item_name: ex1?.name || 'Tomato',
      ...
      },
      {
        ...
        category_name: ex2?.category || '', item_name: ex2?.name || 'Refined Oil',
