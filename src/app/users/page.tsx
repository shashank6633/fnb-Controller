...
const POSITION_TEMPLATES: Array<{
  ...
  { value: 'Head Chef',           label: 'Head Chef',
    defaults: { role: 'manager', is_head_chef: 1, is_store_manager: 0 }, hint: 'Approves requisitions across all kitchens.' },
  { value: 'Sous Chef',           label: 'Sous Chef',
    defaults: { role: 'manager', is_head_chef: 1, is_store_manager: 0 }, hint: 'Can approve requisitions in absence of Head Chef.' },
  { value: 'Bar Manager',         label: 'Bar Manager',
    defaults: { role: 'manager', is_head_chef: 1, is_store_manager: 0 }, hint: 'Approves bar-side requisitions.' },
  { value: 'Operations Manager',  label: 'Operations Manager',
    defaults: { role: 'manager', is_head_chef: 1, is_store_manager: 1 }, hint: 'Approves requisitions AND processes store / vendor POs.' },
  { value: 'Store Manager',       label: 'Store Manager',
    defaults: { role: 'manager', is_head_chef: 0, is_store_manager: 1 }, hint: 'Issues stock + raises vendor POs after chef approval.' },
  { value: 'Storekeeper',         label: 'Storekeeper',
    defaults: { role: 'manager', is_head_chef: 0, is_store_manager: 1 }, hint: 'Same as Store Manager — handles physical stock.' },
  { value: 'Bartender',           label: 'Bartender',
    defaults: { role: 'staff',   is_head_chef: 0, is_store_manager: 0 }, hint: 'Raises requisitions for the Bar.' },
  { value: 'Cook',                label: 'Cook',
    defaults: { role: 'staff',   is_head_chef: 0, is_store_manager: 0 }, hint: 'Raises requisitions for their kitchen.' },
  { value: 'Server',              label: 'Server / Service Staff',
    defaults: { role: 'staff',   is_head_chef: 0, is_store_manager: 0 }, hint: 'Read-only; raises service-side requisitions.' },
