...
const navTree: NavEntry[] = [
  ...
  // Reconciliation page surfaces every break in that chain.
  {
    ...
    items: [
      ...
      { kind: "link", label: "Party Menu",         href: "/dine-in/party-menus",       icon: PartyPopper },
  ...
  // is automatic once the row is here.
  {
    ...
    items: [
      ...
      { kind: "link", label: "Attendance",   href: "/hr/attendance", icon: CalendarClock },
      { kind: "link", label: "Shifts",       href: "/hr/shifts",     icon: Timer },
      { kind: "link", label: "Roster",       href: "/hr/roster",     icon: CalendarCheck },
      { kind: "link", label: "Leave",        href: "/hr/leave",      icon: ClipboardCheck },
      { kind: "link", label: "Payroll & Advances", href: "/hr/payroll", icon: Banknote },
      { kind: "link", label: "Employee Documents", href: "/hr/documents", icon: FileText },
      { kind: "link", label: "SOP Library",  href: "/hr/sops",       icon: BookOpen },
      { kind: "link", label: "Training",     href: "/hr/training",   icon: GraduationCap },
      { kind: "link", label: "Knowledge Tests", href: "/hr/tests",   icon: HelpCircle },
      { kind: "link", label: "Performance",  href: "/hr/performance", icon: BarChart3 },
      { kind: "link", label: "Employee Assets", href: "/hr/assets",  icon: Boxes },
      { kind: "link", label: "Recruitment",  href: "/hr/recruitment", icon: HeartHandshake },
      { kind: "link", label: "Disciplinary & Exits", href: "/hr/exits", icon: ShieldAlert },
      { kind: "link", label: "HR Reports",   href: "/hr/reports",    icon: ClipboardList },
      { kind: "link", label: "Geofences",    href: "/hr/geofences",  icon: Radar },
      { kind: "link", label: "Biometric & Import", href: "/hr/biometric", icon: ScanLine },
